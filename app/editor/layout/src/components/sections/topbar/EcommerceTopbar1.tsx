...
export default function EcommerceTopbar1({ data = {}, blocks }: SectionProps) {
  ...
  const topbarSolidColor = data.topbarBackgroundColor ?? "#00cadd";
  ...
  const topbarBackground =
    data.topbarBackgroundType === "gradient"
      ...
      : topbarSolidColor;
  const topbarTextColor = data.topbarTextColor ?? "#ffffff";
